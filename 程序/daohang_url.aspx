<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="daohang_url.aspx.cs" Inherits="程序.daohang_url" %>
...
<div id="top">
  <div id="header">
        ...
        <asp:SiteMapPath ID="SiteMapPath1" RenderCurrentNodeAsLink="true" ShowToolTips="true" runat="server" Font-Names="Verdana" Font-Size="12" PathSeparator="<<">
        </asp:SiteMapPath> 
        </div>
